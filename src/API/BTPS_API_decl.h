...
public:
	...
	public:
		...
		virtual void GetSelectionWidgetPos2D(float& x, float& y) noexcept = 0;
		virtual void GetSelectionWidgetPos3D(double& x, double& y, double& z) noexcept = 0;

		virtual void StartFadeIn() noexcept = 0;
		virtual void StartFadeOut() noexcept = 0;

		virtual void FadeOutInstant() noexcept = 0;
		virtual void FadeInInstant() noexcept = 0;
	};
